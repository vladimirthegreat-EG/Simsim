...
async function main() {
  ...
  console.log(`║    RUBBER_BAND_TRAILING:   ${(CONSTANTS as any).RUBBER_BAND_TRAILING_BOOST ?? "N/A"}`);
  console.log(`║    RUBBER_BAND_LEADING:    ${(CONSTANTS as any).RUBBER_BAND_LEADING_PENALTY ?? "N/A"}`);
