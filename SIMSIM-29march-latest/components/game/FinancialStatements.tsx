        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <StatementSection title="Long-Term Liabilities">
              <StatementLine label="Long-term Debt" value={statement.liabilities?.longTermLiabilities?.longTermDebt ?? 0} />
              <StatementLine label="Pension Liabilities" value={statement.liabilities?.longTermLiabilities?.pensionLiabilities ?? 0} />
              <StatementLine label="Deferred Tax Liabilities" value={statement.liabilities?.longTermLiabilities?.deferredTaxLiabilities ?? 0} />
              <StatementLine
                label="Total Long-Term Liabilities"
                value={statement.liabilities?.longTermLiabilities?.total ?? 0}
