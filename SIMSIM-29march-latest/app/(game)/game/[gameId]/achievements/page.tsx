...
export default function AchievementsPage({ params }: AchievementsPageProps) {
  ...
  const { data: leaderboard } = trpc.achievement.getLeaderboard.useQuery(
    { gameId },
    { enabled: !!gameId }
  );
    ...
    <div className="space-y-6 pb-24">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          variant="info"
        />
        <div title="Infamy points from negative achievements (layoffs, pollution, misconduct). They reduce your score.">
          <StatCard
            label="Infamy Count"
