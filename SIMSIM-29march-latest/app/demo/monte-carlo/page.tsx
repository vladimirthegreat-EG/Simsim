          ...
          {D.sim.cashPaths[0] && (
            <ChartBox title="Cash Trajectories Sample Game 1">
              <LineChart><CartesianGrid strokeDasharray="3 3" stroke={P.border} />
                ...
                <Tooltip {...TT} formatter={((v: number) => `$${(v / 1e6).toFixed(1)}M`) as any} /><Legend wrapperStyle={{ fontSize: 10 }} />
          ...
          {D.sim.sharePaths[0] && (
            <ChartBox title="Market Share Trajectories Sample Game 1">
              <LineChart><CartesianGrid strokeDasharray="3 3" stroke={P.border} />
                ...
                <Tooltip {...TT} formatter={((v: number) => `${(v * 100).toFixed(1)}%`) as any} /><Legend wrapperStyle={{ fontSize: 10 }} />
