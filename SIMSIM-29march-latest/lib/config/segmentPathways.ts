  ...
  Budget: {
    ...
    phases: [
      ...
      },
      {
        ...
        rdTarget: "bat_1a (battery Tier 1)",
      ...
      },
      {
        ...
        rdTarget: "bat_4b + con_4b (Tier 4 — requires massive R&D)",
  ...
  General: {
    ...
    phases: [
      ...
      },
      {
        ...
        rdTarget: "Any Tier 1: cam_1a, ai_1a, or dsp_1a",
    ...
    phases: [
      {
        ...
        archetypeId: null,
        archetypeName: null,
        rdTarget: "Rush to Tier 2: 300 pts + cam_2b or dsp_2a",
        machineryToAdd: [],
        achievementTargets: ["tech_first_t1"],
    ...
    phases: [
      {
        ...
        archetypeId: null,
        archetypeName: null,
        rdTarget: "Rush Tier 1->2->3: need con_2a + ai_1a minimum for Business Phone",
        machineryToAdd: [],
    ...
    phases: [
      {
        ...
        rdTarget: "dur_1a (durability Tier 1)",
      ...
      },
      {
        name: "Feature Leadership",
        rounds: "3-6",
        archetypeId: "rugged_phone",
        archetypeName: "Rugged Phone",
        rdTarget: "dur_2a (Tier 2)",
